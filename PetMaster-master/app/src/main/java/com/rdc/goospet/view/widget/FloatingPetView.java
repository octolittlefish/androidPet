...
public class FloatingPetView extends LinearLayout {
    ...
    private void defaultPetStatus() {
        switch (new Random().nextInt(12) + 1) {
            case 1:
                setPetImg(R.drawable.tiantiansifangmao01);
                break;
            case 2:
                setPetImg(R.drawable.tiantiansifangmao02);
                break;
            case 3:
                setPetImg(R.drawable.tiantiansifangmao03);
                break;
            case 4:
                setPetImg(R.drawable.tiantiansifangmao04);
                break;
            case 5:
                setPetImg(R.drawable.tiantiansifangmao05);
                break;
            case 6:
                setPetImg(R.drawable.tiantiansifangmao06);
                break;
            case 7:
                setPetImg(R.drawable.tiantiansifangmao07);
                break;
            case 8:
                setPetImg(R.drawable.tiantiansifangmao08);
                break;
            case 9:
                setPetImg(R.drawable.tiantiansifangmao09);
                break;
            case 10:
                setPetImg(R.drawable.tiantiansifangmao10);
                break;
            case 11:
                setPetImg(R.drawable.tiantiansifangmao11);
                break;
            case 12:
                setPetImg(R.drawable.tiantiansifangmao12);
                break;
            default:
                break;
        }
